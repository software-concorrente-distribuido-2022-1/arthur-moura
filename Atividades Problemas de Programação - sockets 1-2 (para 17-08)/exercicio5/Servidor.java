...
class Conexao extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            if (id > 18) saida.println("Adulto.");

            else if (id >=14 && id <= 17) saida.println("Juvenil B");

            else if (id >=11 && id <= 13) saida.println("Juvenil A");

            else if (id >=8 && id <= 10) saida.println("Infantil B");

            else if (id >=5 && id <= 7) saida.println("Infantil A");
